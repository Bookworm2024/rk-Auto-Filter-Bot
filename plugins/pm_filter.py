...
async def pm_search(client, message):
    if PM_SEARCH:
        ...
        if int(total) != 0:
            ...
            await message.reply_text(f'ʜᴏʟᴅ ᴏɴ! <b>ɪ ᴀᴍ ɴᴏᴛ ᴅᴇꜱɪɢɴᴇᴅ ᴛᴏ ᴛᴀᴋᴇ ᴏɴ ᴍᴏᴠɪᴇ/ ꜱᴇʀɪᴇꜱ ʀᴇQᴜᴇꜱᴛꜱ ᴅɪʀᴇᴄᴛʟʏ</b>. ʏᴏᴜ ɴᴇᴇᴅ ᴛᴏ ᴊᴏɪɴ ᴍʏ ʀᴇQᴜᴇꜱᴛ ɢʀᴏᴜᴘ ᴛᴏ ɢᴇᴛ ᴍᴏᴠɪᴇꜱ/ ꜱᴇʀɪᴇꜱ.\n\nᴄʟɪᴄᴋ ᴏɴ ᴛʜᴇ "ʀᴇQᴜᴇꜱᴛ ɢʀᴏᴜᴘ" ʙᴜᴛᴛᴏɴ ᴛᴏ ɢᴏ ᴛʜᴇʀᴇ ᴀɴᴅ ɢᴇᴛ ʏᴏᴜʀ ᴍᴏᴠɪᴇ/ ꜱᴇʀɪᴇꜱ\n\nᴘʟᴇᴀꜱᴇ ɴᴏᴛᴇ, ᴛʜᴇʀᴇ ᴀʀᴇ {total} ꜰɪʟᴇꜱ ɪɴ ᴍʏ ᴅᴀᴛᴀʙᴀꜱᴇ ᴛʜᴀᴛ ᴍᴀᴛᴄʜ ᴛʜᴇ ᴡᴏʀᴅꜱ ʏᴏᴜ ᴊᴜꜱᴛ ᴛʏᴘᴇᴅ ʜᴇʀᴇ. ᴊᴏɪɴ ᴍʏ ʀᴇQᴜᴇꜱᴛ ɢʀᴏᴜᴘ ᴀɴᴅ ɢᴇᴛ ᴛʜᴇ ꜰɪʟᴇꜱ ɴᴏᴡ!!', reply_markup=InlineKeyboardMarkup(btn))
...
async def cb_handler(client: Client, query: CallbackQuery):
    ...
    if query.data.startswith("file"):
        ...
        buttons = [[
            ...
            InlineKeyboardButton('ɢʀᴏᴜᴘ 🕯️', url=FILMS_LINK)
        ]]
        ...
        buttons = [[
            ...
            InlineKeyboardButton('ᴅɪꜱᴄʟᴀɪᴍᴇʀ ⚠️', url='https://telegra.ph/%F0%9D%95%AF%F0%9D%96%8E%F0%9D%96%98%F0%9D%96%88%F0%9D%96%91%F0%9D%96%86%F0%9D%96%8E%F0%9D%96%92%F0%9D%96%8A%F0%9D%96%97-%F0%9D%96%8B%F0%9D%96%94%F0%9D%96%97-%F0%9D%95%BF%F0%9D%96%8D%F0%9D%96%8A-%F0%9D%95%AF%F0%9D%96%8A%F0%9D%96%9B%F0%9D%96%8E%F0%9D%96%91%F0%9D%96%98-%F0%9D%95%BF%F0%9D%96%8D%F0%9D%96%8A%F0%9D%96%86%F0%9D%96%99%F0%9D%96%97%F0%9D%96%8A-10-26')
        ],[
